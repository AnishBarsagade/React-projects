...
const RightCardContent = (props) => {
  return (
    <div className="absolute h-full w-full top-0 left-0 p-6 flex flex-col justify-between">
      ...
      <div>
        <p className=" text-shadow-2xs text-xl leading-relaxed text-white mb-14 font-bold">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus
          architecto pariatur ratione esse porro.
        </p>
        <div className="flex justify-between">
          <button
            style={{ backgroundColor: props.color }}
            className=" text-white font-bold px-8 py-2 rounded-full"
          >
            {props.tag}
          </button>
          <button
